(function($, $document) {
	...
	function showHide(el) {
		el.each(function(i, element) {
			/*
			 * get the selector to find the target elements. its stored as
			 * data-.. attribute
			 */
			...
			if ($(element).data("select")) {
				...
				/*
				 * show the target element that contains the selected value as
				...
				// toggle the target element that contains the selected value as
				// data-showhidetargetvalue attribute
